	...
	<table border="1">
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="jumin2" value="" maxlength="1" style="width: 15px">******
			</td>
		</tr>
		<tr>
			<td>전화번호</td>
		...
		<tr>
			<td>
				...
				<input type="text" id="sample6_extraAddress" placeholder="참고항목" name="extraAddress" readonly>
			</td>
		</tr>
	...
	function save(){
		...
		*/
		if(confirm('등록하시겠습니까?')){
			...
			f.action = "${path }/member/chugaProc";
			f.method = "post";
			f.submit();
		}
	}
